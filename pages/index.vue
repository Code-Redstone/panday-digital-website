<template>
  <v-app > 
        ...
        <v-container>
          <v-row>
            <v-col class=" center"  cols="12" sm="12" md="6" lg="6" xl="6" color="white">
              ...
              <v-btn class="Rounded-botton px-15 py-10 text-lg-h5 text-md-subtitle-1 text-sm-h5"
                elevation="1"
              >Get a Quote
              </v-btn>
              </div>
            ...
            <v-col cols="12" sm="12" md="6" lg="6" xl="6">
              <div class="first-image text-center">
                ...
                max-width="500px"
                max-height="500px"
                :src="require(`~/assets/resources/Right-img-1.png`)"
                />
              </div>
            </v-col>
          </v-row>
    ...
    <v-content>
      <svg id="hill-side-round" style="fill: rgb(27, 117, 187);height: 100px; width: 100%; transform: scaleY(-1) scaleX(-1); position: relative;
    top: 10px;" preserveAspectRatio="none" viewBox="0 0 1442 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <path class="divider-color" d="M1442,34.6187945 C1315.02765,14.2772114 1160.84924,2.89696087 977.282647,2.89696087 C645.766901,2.89696087 281.275997,40.0139604 0,100 L0,0 L1442,0 L1442,34.6187945 Z"></path> </svg>    
      <v-sheet class="" color="#1b75bb" height="100%" width="100%">
        <SearchEngine/>
      </v-sheet>
    </v-content>
    <v-content>
          ...
          <v-row>
            ...
            <v-col class="d-flex" sm="12" md="6" lg="6" xl="6" >
              <div class="div ">
                ...
                There certainly is. The final status of your digital marketing strategy and how it looks to the eye and the results it yields are proof of our skill and competence in the field, but how we go about it, that entire procedure is a wholesome display of our service.<br></p>
              </div>
            </v-col>
          </v-row>
        </v-container>
...
.Digital-Services:hover{
    box-shadow: 0px 3px 60px 3px rgb(45, 153, 236);
}
